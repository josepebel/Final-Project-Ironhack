...
public class LaptopDTONativo {
    ...
    public LaptopDTONativo() {
    }

    public LaptopDTONativo(String image, String brand, String model, double price, String url, LocalDate fabricDate, String cpu, String ram, String rom, String graphics, String resolution, String os, int battery, double weight) {
        this.image = image;
        this.brand = brand;
        this.model = model;
        this.price = price;
